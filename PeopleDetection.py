...
model = YOLO("C:\\Users\\dungc\\Downloads\\yolov8n.pt")  # load model
...
save_dir = "Z:\\School\\Workspace_Py\\activityDetection\\FrameByFrame"  # Directory to save the crops
    ...
    if ret:
        ...
        if results is not None and results[0].boxes is not None:
            ...
            for i, det in enumerate(results[0].boxes.xyxy):
                ...
                if results[0].boxes.xyxy =="Cell Phone":
                    cv2.putText(frame, "spoofed Detected", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
